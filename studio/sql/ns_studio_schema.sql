...
--
-- Current Database: `readysetshows`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `readysetshows` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
--
-- Table structure for table `booking_bids`
--

DROP TABLE IF EXISTS `booking_bids`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `booking_bids` (
  ...
  `bidder_profile_id` bigint(20) unsigned NOT NULL,
...
CREATE TABLE `booking_invites` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `request_id` bigint(20) unsigned NOT NULL,
  `target_profile_id` bigint(20) unsigned NOT NULL,
  ...
  KEY `fk_invites_decline_reason` (`decline_reason_id`),
  CONSTRAINT `fk_invite_request` FOREIGN KEY (`request_id`) REFERENCES `booking_requests` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_invites_decline_reason` FOREIGN KEY (`decline_reason_id`) REFERENCES `decline_reasons` (`id`) ON DELETE SET NULL
...
CREATE TABLE `decline_reasons` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `target_type` enum('artist','venue','any') NOT NULL DEFAULT 'any',
  `label` varchar(80) NOT NULL,
  `sort_order` int(11) NOT NULL DEFAULT 100,
  `is_active` tinyint(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uniq_target_label` (`target_type`,`label`),
...
) ENGINE=InnoDB AUTO_INCREMENT=2728 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_calendars` (
  ...
  KEY `idx_user_calendars_user_default_deleted` (`user_id`,`is_default`,`deleted_at`),
...
-- Dump completed on 2026-02-24 18:10:30
