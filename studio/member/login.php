...
<head>
  ...
  <title><?= $isReadySetShowsHost ? 'Log In | Ready Set Shows' : 'Studio Login • Nick Sanzeri' ?></title>
...
<main class="container" style="padding:3rem 0; max-width:720px;">
  <h1>Log in</h1>
  <p class="muted"><?= $isReadySetShowsHost ? 'Access Ready Set Shows tools, subscriptions, and account settings.' : 'Access My Products, re-download past purchases, and manage your account.' ?></p>
