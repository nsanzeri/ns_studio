...
if ($directoryReady) {
    ...
    $sql = "
        ...
        {$where}
        GROUP BY pp.user_id, pp.directory_state, pp.artist_name, pp.website_url, pp.logo_path, u.display_name" . ($linksReady ? ", spl.public_token" : "") . "
...
<head>
  ...
  <style>
    ...
    .directory-actions a { display:inline-flex; align-items:center; min-height:34px; padding:.45rem .7rem; border-radius:8px; font-size:.9rem; text-decoration:none; border:1px solid rgba(255,255,255,.12); color:rgba(255,255,255,.9); }
    .directory-actions a:hover { border-color:rgba(212,175,55,.36); color:#f4d57a; }
        ...
        <article class="directory-card">
          ...
          <div>
            ...
            <div class="directory-meta">
              ...
              <?php if ((int)$artist['active_song_count'] > 0): ?>
