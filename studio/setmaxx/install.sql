...
CREATE TABLE IF NOT EXISTS `setmaxx_requests` (
  ...
  `requester_identifier` char(64) DEFAULT NULL,
  `requester_ip` varchar(45) DEFAULT NULL,
  `requester_user_agent` varchar(255) DEFAULT NULL,
  `request_referrer` varchar(255) DEFAULT NULL,
  `request_source_url` varchar(255) DEFAULT NULL,
  ...
  KEY `idx_setmaxx_requests_requester_free` (`requester_identifier`,`payment_method`,`created_at`),
