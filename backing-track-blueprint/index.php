...
define('ORIGINAL_PRICE', '$67');
define('SALE_PRICE', '$17');
define('PRICE_DISPLAY', SALE_PRICE);
?>
<!doctype html>
<html lang="en">
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .wasPrice{color:var(--muted); font-size:14px; text-decoration:line-through; opacity:.9}
    .nowLine{display:flex; align-items:baseline; gap:10px; flex-wrap:wrap;}
    .saleBadge{
    ...
    .storyLead{font-size:18px; color:var(--muted); margin-top:0; max-width:72ch}
    .storyGrid{display:grid; gap:12px; margin-top:14px}
    .storyBlock{
      border:1px solid var(--line);
      border-radius: 14px;
      background: rgba(255,255,255,.03);
    ...
    .storyBlock p{margin:0; color:var(--muted)}
...
<body>
  <div class="wrap">
    <div class="topbar">
      ...
      <div style="display:flex; gap:10px; align-items:center; flex-wrap:wrap;"><a class="pill" href="#the-story">Read the story</a><a class="pill" href="https://nicksanzeri.com">Back to site</a></div>
    </div>
    ...
    <div class="hero">
      <div class="card hero-left">
        ...
        <div class="ctaRow">
          <a class="btn" href="<?= htmlspecialchars(PRODUCT_URL) ?>" target="_blank" rel="noopener">
            Buy & Download Instantly — <span class="wasPrice"><?= htmlspecialchars(ORIGINAL_PRICE) ?></span> <span><?= htmlspecialchars(PRICE_DISPLAY) ?></span> <span aria-hidden="true">→</span>
          </a>
      ...
      <div class="card hero-right">
        <div class="mock">
          ...
          <div class="priceBox">
            <div>
              <div class="priceWrap"><div class="wasPrice"><?= htmlspecialchars(ORIGINAL_PRICE) ?></div><div class="nowLine"><div class="price"><?= htmlspecialchars(PRICE_DISPLAY) ?></div><span class="saleBadge">Price Slashed</span></div></div>
    ...
    <div class="card section" id="the-story" style="margin-top:16px;">
      <h2>The moment backing tracks stopped being “cheating” and started being the upgrade</h2>
      <p class="storyLead">
        I didn’t wake up one day and decide to become a “tracks guy.” I was a purist too — until reality forced the issue.
        Here’s what actually happened.
      </p>

      <div class="storyGrid">
        <div class="storyBlock">
          <div class="storyTag">My Story</div>
          <p>
            For years, I was in a three‑piece band that sounded really good. Drums, guitar, bass — I sang lead. Tight rehearsals, good songs.
            Once in a while we’d land opening slots for bigger acts… but we only played maybe <strong style="color:var(--text)">5 to 12 shows a year</strong>.
            And every time we opened, we’d get blown off the stage — not because we were bad, but because they sounded <strong style="color:var(--text)">huge</strong>.<br>
            Massive vocals. Locked tempos. Effortless transitions.<br>
            Looking back now? They were supplementing their sound.<br><br>
          </p>
          <p>
            One night, after a show I thought went great, I listened back to the recording.<br>
            What I heard shocked me: every song… same tempo… all night — and it was a fast one.<br>
            We were so adrenalized we rushed everything. No breath. No dynamics. That was the first crack in the armor.<br><br>
          </p>
          <p>
            Tight isn’t just playing the notes. Tight is tempo control. Tight is structure. Tight is restraint.<br>
            Energy without control doesn’t sound exciting — it sounds frantic.<br><br>
          </p>
          <p>
            So we tiptoed. First: a click track. Then we started covering more modern, dance‑driven songs with production we loved…<br>
            but we had no keyboard player. So we added a pad here, a tambourine there.<br>
            Then I wanted vocal harmonies — but I was the only singer — so… a harmony here and there.<br><br>
          </p>
          <p>
            My band hated it at first. They were purists. They thought it was cheating.<br>
            But my take was simple: we weren’t cheating — we were adding invisible players.<br>
            Players who always showed up prepared, always knew the structure, always played the right tempo, always played in the right key.<br>
            And if we were going to play with them… we had to level up.<br><br>
          </p>
          <p>
            Something wild happened. We started sounding better. People started dancing — not just watching.<br>
            And at <strong style="color:var(--text)">every single show</strong>, someone offered us another gig. No chasing. No begging.<br>
            (True story: the guitar player even met his future ex‑wife at one of those shows.)<br>
            All of a sudden we weren’t stressed — we were confident, having fun, and finally playing at the level we always thought we were.<br><br>
          </p>
          <p>
            Here’s the part nobody says out loud: tracks don’t replace musicianship — they demand it.<br>
            They remove the places inconsistency hides (tempo drift, fuzzy transitions, “we’ll feel it out” endings).<br>
            Some players resist not because it’s “wrong,” but because they can feel the challenge:<br>
            <em>“If we do this, I’ll have to rise to meet a fixed standard.”</em><br>
            Tracks are just invisible bandmates with perfect time and perfect memory — and they force the whole group to get serious.<br><br>
          </p>
        </div>
      </div>
      ...
      <div class="ctaRow">
        <a class="btn" href="<?= htmlspecialchars(PRODUCT_URL) ?>" target="_blank" rel="noopener">
          Get the Blueprint — <span class="wasPrice"><?= htmlspecialchars(ORIGINAL_PRICE) ?></span> <span><?= htmlspecialchars(PRICE_DISPLAY) ?></span> <span aria-hidden="true">→</span>
        </a>
        <div class="smallnote">Secure checkout • Instant download • Re-download anytime</div>
      </div>
    </div>
    ...
    <div class="grid">
      <div class="card section" id="is-this-for-me">
        ...
        <div style="height:14px"></div>
        <a class="btn" href="<?= htmlspecialchars(PRODUCT_URL) ?>" target="_blank" rel="noopener">Buy & Download Instantly — <span class="wasPrice"><?= htmlspecialchars(ORIGINAL_PRICE) ?></span> <span><?= htmlspecialchars(PRICE_DISPLAY) ?></span> →</a>
